        ...
        function gameMusic() {
            var music = new Audio("simple-piano-melody-9834.mp3");
            music.play()
        }
            ...
            if (yourLoversName == "" || yourName == "") {
                ...
                <h1 class="display-6"> <b style="font-size:1em;"> ✔✔✔</b>
                    <br>
                        ...
                        <p style="color:white;">made for you ${yourLoversName}</P> 
                    </h1>
                `
                lover.value = ""
                playerName.value = ""
                ...
                <h1 class="display-6"> <b style="font-size:1em;"> ⚠⚠⚠</b>
                    <br>
                        ...
                        <b style="font-size:1em;">${randomNumber}%</b>
                        <p style="color:white;">${yourName}!! dey play just dey play.</P> 
                    </h1>
                `
                lover.value = ""
                    playerName.value = ""
                lessThanSeventy.play()
                    ...
                    <h1 class="display-6"> <b style="font-size:1em;"> 😆😆😆</b>
                        <br>
                            ...
                            <b style="font-size:1em;">${randomNumber}%</b>
                            <p style="color:white;">Scam‼  Japa.</P> 
                        </h1>
                    `
                    lover.value = ""
                    playerName.value = ""
                    ...
                    <h1 class="display-6"> <b style="font-size:1em;">🚩🚩🚩</b>
                        <br>
                            <p style="color:red;">You and ${yourLoversName} match</P> 
                            <b style="font-size:1em;">${randomNumber}%</b>
                            <p style="color:white;">RED FLAG 😁😁 Na agbero you wan marry.</P> 
                        </h1>
                    `
                    lover.value = ""
                    playerName.value = ""
                    ...
                    <h1 class="display-6"> <b style="font-size:1em;"> 😀😀😁</b>
                        <br>
                            <p style="color:red;">You and ${yourLoversName} match</P> 
                            <b style="font-size:1em;">${randomNumber}%</b>
                            <p style="color:white;">You go soon chop breakfast</P> 
                        </h1>
                    `
                    lover.value = ""
                    playerName.value = ""
